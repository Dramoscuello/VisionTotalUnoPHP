<!--CONSTANTE EN TODAS LAS PÁGINAS --> 
        <!-- Menu mobile-->
        <nav class="nav_mov hidden-md hidden-lg">	
            <ul class="menu">
                <li><a href="index.php"><span class="icon-home3"></span> Inicio</a></li>
                <li class="quienes_show"><a href="quienes_somos.php"><span class="icon-users"></span> Quienes Somos</a>
                </li>
        ...
        <header>
            ...
            <!-- navegación grande -->
            <div class="nav hidden-xs hidden-sm cont_nav_big">
                <div class="container">
                    <div class="row">
                        <nav class="col-md-12 col-lg-12 nav_big">
                            <ul>
                                <li><a href="index.php"><span class="icon-home3"></span> INICIO</a></li>
                                <li><a href="quienes_somos.php"><span class="icon-users"></span> QUIENES SOMOS</a>
                                </li>
